...
def PET_2TC_KM(input_aorta_TAC, input_portal_TAC, t, k1, k2, k3, Vb, alpha, beta, step=0.1):
...
def PET_2TC_KM_batch(input_aorta_TAC, input_portal_TAC, t, k1, k2, k3, Vb, alpha, beta, step=0.1):

    a = alpha * input_aorta_TAC + beta* input_portal_TAC  #(1, h*w, 600)
